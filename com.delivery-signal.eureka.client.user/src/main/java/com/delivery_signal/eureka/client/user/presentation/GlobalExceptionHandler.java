package com.delivery_signal.eureka.client.user.presentation;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleServiceException(ServiceException e) {
        log.warn("서비스 예외 발생: {}", e);
