package com.delivery_signal.eureka.client.delivery.common;
...
public enum UserRole {
    ...
    DELIVERY_MANAGER(Authority.DELIVERY_MANAGER),   // 배송 관리자 권한 (담당자)
    SUPPLIER_MANAGER(Authority.SUPPLIER_MANAGER);   // 업체 관리자 권한 (담당자)
