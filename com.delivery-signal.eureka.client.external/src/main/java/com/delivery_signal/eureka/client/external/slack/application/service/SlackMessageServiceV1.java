...
public class SlackMessageServiceV1 {
    ...
    private String createPromptFromDto(CreateSlackMessageRequestDto requestDto){
        String info =
        ...
        return info+"\n 해당정보를 고려해서 납기에 맞출수있는 최종 발송 시한을 알려줘 답변은 " +
                "'주문번호 :"+requestDto.getOrderNum()+" 의 최종 발송시한은 ** 입니다.'형태로 설명을 제외하고 답변만 보내줘";
    }
}
